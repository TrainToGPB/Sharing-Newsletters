...
| 날짜 | 제목 | 요약 |
| --- | --- | --- |
| 2026-06-10 | [MAI-Thinking-1: Microsoft의 reasoning model을 만든 hill-climbing machine](2026-06-10-mai-thinking-1/) | MAI-Thinking-1은 35B active / 약 1T total MoE reasoning model이지만, 보고서의 핵심은 모델 자체보다 pre-training, RL, 평가, 인프라를 빠르게 반복하는 hill-climbing machine이다. |
